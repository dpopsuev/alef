...
| Package | Purpose |
|---------|---------|
| `@dpopsuev/alef-coding-agent` | Extension types (`ExtensionAPI`, `ExtensionContext`, events) |
| `typebox` | Schema definitions for tool parameters |
| `@dpopsuev/alef-ai` | AI utilities (`StringEnum` for Google-compatible enums) |
| `@dpopsuev/alef-tui` | TUI components for custom rendering |
...
```typescript
import { isToolCallEventType } from "@dpopsuev/alef-coding-agent";
...
```typescript
import { isBashToolResult } from "@dpopsuev/alef-coding-agent";
...
```typescript
import { createLocalBashOperations } from "@dpopsuev/alef-coding-agent";
...
```typescript
import { SessionManager } from "@dpopsuev/alef-coding-agent";
...
```typescript
import type { AutocompleteItem } from "@dpopsuev/alef-tui";
...
```typescript
import { withFileMutationQueue } from "@dpopsuev/alef-coding-agent";
...
**Important:** Use `StringEnum` from `@dpopsuev/alef-ai` for string enums. `Type.Union`/`Type.Literal` doesn't work with Google's API.
...
```typescript
import { createReadTool, createBashTool, type ReadOperations } from "@dpopsuev/alef-coding-agent";
...
```typescript
import { keyHint } from "@dpopsuev/alef-coding-agent";
...
```typescript
import { Text, Component } from "@dpopsuev/alef-tui";
...
```typescript
import { highlightCode, getLanguageFromPath } from "@dpopsuev/alef-coding-agent";
