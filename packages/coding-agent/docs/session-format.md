...
```
<agent-dir>/sessions/--<path>--/<timestamp>_<uuid>.jsonl
```
...
Sessions can be removed by deleting their `.jsonl` files under `<agent-dir>/sessions/`.
...
For TypeScript definitions in your project, inspect `node_modules/@dpopsuev/alef-coding-agent/dist/` and `node_modules/@dpopsuev/alef-ai/dist/`.
