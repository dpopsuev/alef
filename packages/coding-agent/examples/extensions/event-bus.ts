 ...
 *
 * Shows alef.events for communication between extensions. One extension
...
export default function (alef: ExtensionAPI) {
	...
	alef.events.on("my:notification", (data) => {
