 ...
 * working indicator shown while Alf is streaming a response.
 *
 * Usage:
 *   alf --extension examples/extensions/working-indicator.ts
 *
 * Commands:
 ...
 *   /working-indicator reset     Restore Alf's default spinner
 */
