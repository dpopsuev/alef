 ...
 * working indicator shown while Alef is streaming a response.
 *
 * Usage:
 *   alef --extension examples/extensions/working-indicator.ts
 *
 * Commands:
...
export default function (alef: ExtensionAPI) {
	...
	alef.registerCommand("working-indicator", {
