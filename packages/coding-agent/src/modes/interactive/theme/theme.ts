...
import type { EditorTheme, MarkdownTheme, SelectListTheme } from "@dpopsuev/alef-tui";
...
const THEME_KEY = Symbol.for("@dpopsuev/alef-coding-agent:theme");
...
export function getSettingsListTheme(): import("@dpopsuev/alef-tui").SettingsListTheme {
	return {
