...
import type { EditorTheme, MarkdownTheme, SelectListTheme } from "@alf-agent/tui";
...
const THEME_KEY = Symbol.for("@alf-agent/coding-agent:theme");
...
export function getSettingsListTheme(): import("@alf-agent/tui").SettingsListTheme {
	return {
