...
import { buildRegistryFromSnapshot } from "./models-snapshot.js";

const COST_PER_MILLION = 1_000_000;

const modelRegistry = buildRegistryFromSnapshot();

/** Shared registry used by Node refresh and browser lookup. */
export function getModelRegistry(): Map<string, Map<string, Model<Api>>> {
