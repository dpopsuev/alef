...
const CHANNEL_REGISTRY: ReadonlyMap<string, ChannelName> = new Map<string, ChannelName>([
	...
	["llm.tool-progress", "notification"],
	["llm.tool-heartbeat", "notification"],
	["llm.tool-wake", "notification"],
	["llm.tool-budget-extended", "notification"],
	["llm.tool-stall", "notification"],
	["llm.tool-validation-error", "notification"],
	["llm.token-usage", "notification"],
	["telemetry.progress.step", "notification"],
	["telemetry.progress.outcome", "notification"],
	...
	["plan.handed-off", "notification"],
	["plan.dss", "notification"],
	["step.ready", "notification"],
	["step.claimed", "notification"],
	["step.started", "notification"],
	["step.completed", "notification"],
	["step.failed", "notification"],
	["work.enqueued", "notification"],
	["pr.opened", "notification"],
	["pr.updated", "notification"],
	["pr.reviewed", "notification"],
