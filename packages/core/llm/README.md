...
```bash
npm install @dpopsuev/alef-ai
```

TypeBox exports are re-exported from `@dpopsuev/alef-ai`: `Type`, `Static`, and `TSchema`.

## Quick Start

```typescript
import { Type, getModel, stream, complete, Context, Tool, StringEnum } from '@dpopsuev/alef-ai';
...
```typescript
import { Type, Tool, StringEnum } from '@dpopsuev/alef-ai';
...
```typescript
import { stream, validateToolCall, Tool } from '@dpopsuev/alef-ai';
...
```typescript
import { readFileSync } from 'fs';
import { getModel, complete } from '@dpopsuev/alef-ai';
...
```typescript
import { getModel, streamSimple, completeSimple } from '@dpopsuev/alef-ai';
...
```typescript
import { getModel, stream } from '@dpopsuev/alef-ai';
...
```typescript
import { getProviders, getModels, getModel } from '@dpopsuev/alef-ai';
...
```typescript
import { Model, stream } from '@dpopsuev/alef-ai';
...
```typescript
import { streamAnthropic, type AnthropicOptions } from '@dpopsuev/alef-ai';
...
```typescript
import { getModel, complete, Context } from '@dpopsuev/alef-ai';
...
```typescript
import { Context, getModel, complete } from '@dpopsuev/alef-ai';
...
- OAuth login flows are not supported in browser environments. Use the `@dpopsuev/alef-ai/oauth` entry point in Node.js.
...
```bash
npx @dpopsuev/alef-ai login              # interactive provider selection
npx @dpopsuev/alef-ai login anthropic    # login to specific provider
npx @dpopsuev/alef-ai list               # list available providers
```
...
The library provides login and token refresh functions via the `@dpopsuev/alef-ai/oauth` entry point. Credential storage is the caller's responsibility.
...
} from '@dpopsuev/alef-ai/oauth';
```

### Login Flow Example

```typescript
import { loginGitHubCopilot } from '@dpopsuev/alef-ai/oauth';
...
```typescript
import { getModel, complete } from '@dpopsuev/alef-ai';
import { getOAuthApiKey } from '@dpopsuev/alef-ai/oauth';
...
- Add any root-level `export type` re-exports in `src/index.ts` that should remain available from `@dpopsuev/alef-ai`
