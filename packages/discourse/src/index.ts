...
export type DiscourseLabelSource = "auto" | "operator" | "agent" | "coordinator" | "system";
...
export interface DiscourseAddress {
	boardId: string;
	forumId?: string;
	topicId?: string;
	threadId?: string;
...
export interface DialogDiscoursePort {
...
export interface MonologDiscoursePort {
...
export interface DiscourseOrganPorts {
	dialog: DialogDiscoursePort;
	monolog: MonologDiscoursePort;
}

export interface AgentDiscoursePort extends DialogDiscoursePort, MonologDiscoursePort {}
...
export function createDiscourseOrganPorts(
	dialog: DialogDiscoursePort,
	monolog?: MonologDiscoursePort,
): DiscourseOrganPorts {
	const resolvedMonolog = monolog ?? (dialog as unknown as MonologDiscoursePort);
	return {
		dialog,
		monolog: resolvedMonolog,
	};
}

export function asAgentDiscoursePort(ports: DiscourseOrganPorts): AgentDiscoursePort {
	return ports.dialog as AgentDiscoursePort;
}
