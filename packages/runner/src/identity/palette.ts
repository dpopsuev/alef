/**
 * Color palette for agent visual identity.
 *
 * 12 color families × 12 shades = 144 unique agent addresses.
 * Ported from ~/Workspace/tangle/visual/color.go (DefaultPalette).
...
export const PALETTE: PaletteFamily[] = [
	...
	},
	{
		...
		colors: [
			...
			{ name: "flint", hex: "#6F6F6F" },
			{ name: "stone", hex: "#928E85" },
			{ name: "taupe", hex: "#483C32" },
			{ name: "dusk", hex: "#B6B8A4" },
			{ name: "gravel", hex: "#7D8471" },
		],
	},
	{
		family: "white",
	...
	},
	{
		...
		colors: [
			...
			{ name: "jet", hex: "#343434" },
			{ name: "raven", hex: "#073763" },
			{ name: "obsidian", hex: "#1B1B1B" },
			{ name: "sable", hex: "#282C34" },
			{ name: "void", hex: "#080808" },
			{ name: "pitch", hex: "#1C1C1C" },
			{ name: "shadow", hex: "#2D2B2A" },
			{ name: "eclipse", hex: "#1A1A2E" },
			{ name: "abyss", hex: "#0D0D0D" },
			{ name: "vantablack", hex: "#141414" },
		],
	},
];
