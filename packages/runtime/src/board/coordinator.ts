...
import { type AgentColor, COORDINATOR_COLOR, ColorRegistry } from "./color-registry.js";
...
export class GeneralSecretary {
	readonly color: AgentColor = COORDINATOR_COLOR;
	...
	routeMessage(
		text: string,
	): { target: "coordinator"; text: string } | { target: "agent"; agentId: string; text: string } {
		...
		return { target: "coordinator", text };
	}
}
